...
android {
    ...
    kotlinOptions {
        jvmTarget = "17"
        // Opt-in to experimental Material3 APIs globally. This avoids per-file
        // annotations for ExperimentalMaterial3Api and ensures that Compose
        // compiles without errors when using experimental components.
